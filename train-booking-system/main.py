...
root = Tk()
root.title("Python Railway Service")
...
def new_run():
    ...
    Label(
        f17, text="Python Railway Service", font=("Arial", 25), bg="deep sky blue", fg="red"
    ...
    Label(f18, text="Train Id ", font=("Arial", 15), fg="light green").grid(
    ...
    def delete_run():
        ...
        showinfo("Deleted", "Train running details deleted successfully!!")
...
def new_route():
    ...
    Label(
        f15, text="Python Railway Service", font=("Arial", 25), bg="deep sky blue", fg="red"
    ).grid(row=1, column=0, columnspan=5)
    Label(f15, text="Add Train Route Details", font=("Arial", 25), fg="light green").grid(
...
def new_bus():
    ...
    Label(
        f13, text="Python Railway Service", font=("Arial", 25), bg="deep sky blue", fg="red"
    ).grid(row=1, column=0, columnspan=5, sticky="nsew")
    Label(f13, text="Add Train Details", font=("Arial", 25), fg="light green").grid(
        row=2, column=0, columnspan=1, pady=20, sticky="nsew"
    )

    f14 = Frame(f13)
    f14.grid(row=3, column=0, columnspan=15, pady=2, sticky="nsew")
    Label(f14, text="Train Id ", font=("Arial", 15), fg="light green").grid(
    ...
    def add_bus():
        ...
        already = cur.fetchall()
        if len(already):
            showerror("Error", "Train Id already exist")
        else:
            cur.execute(
    ...
    def delete_bus():
        ...
        showinfo("Deleted", "Train Details Deleted Successfully")
...
def new_operator():
    ...
    Label(
        f11, text="Python Railway Service", font=("Arial", 25), bg="deep sky blue", fg="red"
    ).grid(row=1, column=0, columnspan=5)
    Label(f11, text="Add Train Operator Details", font=("Arial", 25), fg="green").grid(
...
def ticketShow(row):
    ...
    Label(
        f4, text="Python Railway Service", font=("Arial", 25), bg="deep sky blue", fg="red"
    ).grid(row=1, column=0, columnspan=5)
    Label(
        f4, text="Train TICKET", font=("Arial", 20), bg="light green", fg="green4", bd=5
    ...
    Label(final, text="Train Id: " + str(row[4]) + "                       ").grid(
...
def seat_book():
    ...
    label5 = Label(
        f5, text="JOURNEY DATE (DD-MM-YYYY) ", font=("Arial", 10, "bold")
    ...
    def proceed_to(f5, busch, fare):
        if type(busch) != int:
            showinfo("Invalid Choice", "Please choose a Train!")
        else:
            f6.grid(row=6, column=0, columnspan=11, pady=20)
            Label(
                f6,
                text="Fill Passenger Details To Book The Train Ticket",
                font=("Arial", 16),
                bg="deep sky blue",
                fg="red",
    ...
    def show_bus(f5):
        if e1.get() == "":
            ...
            Label(f6, text="Train Type ", font=("Arial", 15), fg="light green").grid(
                row=0, column=2, padx=20
            )
            ...
            i, busch = 1, IntVar()
            for row in data:
                rb = Radiobutton(f6, text="Train" + str(i), variable=busch, value=row[0])
                ...
                i += 1
            if i == 1:
                showinfo("Not Found", "No Train found for given details!")
            button7 = Button(
                f6,
...
def add_bus():
    def all_bus():
        ...
        root.title("AlL Train")
        Label(root, text="All Train Availabe : ").place(x=20, y=20)

        Label(root, text="Train ID", font=("Arial", 15)).place(x=20, y=80)
        Label(root, text="Train Type", font=("Arial", 15)).place(x=100, y=80)
...
def download_ticket():
    ...
    pdf.multi_cell(0, 10, txt="Python Railway Service", align="C")
