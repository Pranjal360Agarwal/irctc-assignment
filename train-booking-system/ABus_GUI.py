...
def Landing_page():
    ...
    window = tk.Tk()
    window.title("IRCTC Railway Booking Reservation")
    ...
    welcome_text = tk.Label(
        ribbon,
        text="IRCTC Railway Booking Reservation - Signin/Register to continue",
        bg="#B1D6C6",
    ...
    edge_text = tk.Label(
        window, text="Welcome to IRCTC Railway", bg="#B7C3EC", font=("Georgia", 35)
    )
